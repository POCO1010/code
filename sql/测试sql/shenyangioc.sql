...
-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_cpyy_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_cpyy_zb`;
CREATE TABLE `t_ywym_ywtg_hbs_cpyy_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `zwfwzxmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '政务服务中心名称',
  `cpyy` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '差评原因'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_差评原因_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_cpyy_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 2, '沈河区政务服务中心', '态度差');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 3, '沈河区政务服务中心', '服务效率低');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 4, '沈河区政务服务中心', '差别对待');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 5, '沈河区政务服务中心', '专业性差');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 6, '沈河区政务服务中心', '服务质量差');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 1, '沈河区政务服务中心', '窗口少');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 1, '浑南区政务服务中心', '服务意识差');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 2, '浑南区政务服务中心', '态度差');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 3, '浑南区政务服务中心', '服务效率低');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 4, '浑南区政务服务中心', '差别对待');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 5, '浑南区政务服务中心', '专业性差');
INSERT INTO `t_ywym_ywtg_hbs_cpyy_zb` VALUES (NULL, NULL, NULL, 6, '浑南区政务服务中心', '服务质量差');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_dwcppmtop_lb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_dwcppmtop_lb`;
CREATE TABLE `t_ywym_ywtg_hbs_dwcppmtop_lb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `zwfwzxmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '政务服务中心名称',
  `dwmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位名称',
  `sx` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '事项',
  `cps` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '差评数',
  `aqzgl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '按期整改率'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_单位差评排名TOP5_列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_dwcppmtop_lb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 4, '浑南区政务服务中心', '单位名称', '4事项', '33', '48.9');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 2, '浑南区政务服务中心', '单位名称', '2事项', '56', '75.6');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 3, '浑南区政务服务中心', '单位名称', '3事项', '25', '58.6');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 5, '浑南区政务服务中心', '单位名称', '5事项', '13', '93.3');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 1, '浑南区政务服务中心', '单位名称', '1事项', '33', '93.3');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 1, '沈河区政务服务中心', '单位名称', '1事项', '33', '93.3');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 2, '沈河区政务服务中心', '单位名称', '2事项', '56', '75.6');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 3, '沈河区政务服务中心', '单位名称', '3事项', '25', '58.6');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 4, '沈河区政务服务中心', '单位名称', '4事项', '33', '48.9');
INSERT INTO `t_ywym_ywtg_hbs_dwcppmtop_lb` VALUES (NULL, NULL, NULL, 5, '沈河区政务服务中心', '单位名称', '5事项', '13', '93.3');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_gcsp_gjjdys_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_gcsp_gjjdys_zb`;
CREATE TABLE `t_ywym_ywtg_hbs_gcsp_gjjdys_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_工程审批_关键节点用时_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_gcsp_gjjdys_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 1, '科研审批/核准批复', 1, '天');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 2, '建设工程规划许可证', 3, '天');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 3, '建设工程施工许可证', 1, '天');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 4, '联合验收备案证', 1, '天');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 5, '规划设计方案联合审定', 7, '天');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 6, '施工图联合审查', 9, '天');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gjjdys_zb` VALUES (NULL, NULL, NULL, 7, '多测合一', 7, '天');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_gcsp_gzhfsl_qs
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs`;
CREATE TABLE `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `gzhfsl` decimal(20, 0) NULL DEFAULT NULL COMMENT '跟踪回访数量'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_工程审批_跟踪回访数量_趋势' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_gcsp_gzhfsl_qs
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs` VALUES (NULL, NULL, NULL, 1, '1月', 2423);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs` VALUES (NULL, NULL, NULL, 2, '2月', 1253);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs` VALUES (NULL, NULL, NULL, 3, '3月', 3625);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs` VALUES (NULL, NULL, NULL, 4, '4月', 1245);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs` VALUES (NULL, NULL, NULL, 5, '5月', 559);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_gzhfsl_qs` VALUES (NULL, NULL, NULL, 6, '6月', 687);

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_gcsp_kgxm_zzt
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_gcsp_kgxm_zzt`;
CREATE TABLE `t_ywym_ywtg_hbs_gcsp_kgxm_zzt`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `xmkgs` decimal(20, 0) NULL DEFAULT NULL COMMENT '项目开工数'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_工程审批_开工项目_柱状图' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_gcsp_kgxm_zzt
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_gcsp_kgxm_zzt` VALUES (NULL, NULL, NULL, 1, '1月', 2423);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_kgxm_zzt` VALUES (NULL, NULL, NULL, 2, '2月', 1253);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_kgxm_zzt` VALUES (NULL, NULL, NULL, 3, '3月', 3625);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_kgxm_zzt` VALUES (NULL, NULL, NULL, 4, '4月', 1245);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_kgxm_zzt` VALUES (NULL, NULL, NULL, 5, '5月', 559);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_kgxm_zzt` VALUES (NULL, NULL, NULL, 6, '6月', 687);

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_gcsp_spys_qs
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_gcsp_spys_qs`;
CREATE TABLE `t_ywym_ywtg_hbs_gcsp_spys_qs`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `spys` decimal(20, 2) NULL DEFAULT NULL COMMENT '审批用时'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_工程审批_审批用时_趋势' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_gcsp_spys_qs
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_gcsp_spys_qs` VALUES (NULL, NULL, NULL, 1, '1月', 2423.00);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_spys_qs` VALUES (NULL, NULL, NULL, 2, '2月', 1253.00);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_spys_qs` VALUES (NULL, NULL, NULL, 3, '3月', 3625.00);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_spys_qs` VALUES (NULL, NULL, NULL, 4, '4月', 1245.00);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_spys_qs` VALUES (NULL, NULL, NULL, 5, '5月', 559.00);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_spys_qs` VALUES (NULL, NULL, NULL, 6, '6月', 687.00);

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_gcsp_yqbj_zzt
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_gcsp_yqbj_zzt`;
CREATE TABLE `t_ywym_ywtg_hbs_gcsp_yqbj_zzt`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `yqbjs` decimal(20, 0) NULL DEFAULT NULL COMMENT '逾期办件数'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_工程审批_逾期办件_柱状图' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_gcsp_yqbj_zzt
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_gcsp_yqbj_zzt` VALUES (NULL, NULL, NULL, 1, '1月', 2423);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_yqbj_zzt` VALUES (NULL, NULL, NULL, 2, '2月', 1253);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_yqbj_zzt` VALUES (NULL, NULL, NULL, 3, '3月', 3625);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_yqbj_zzt` VALUES (NULL, NULL, NULL, 4, '4月', 1245);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_yqbj_zzt` VALUES (NULL, NULL, NULL, 5, '5月', 559);
INSERT INTO `t_ywym_ywtg_hbs_gcsp_yqbj_zzt` VALUES (NULL, NULL, NULL, 6, '6月', 687);
...
CREATE TABLE `t_ywym_ywtg_hbs_gcsp_zb`  (
  ...
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_工程审批_指标（右侧全部）' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_gcsp_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 1, '项目总数', 24532.00, '个');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 2, '项目金额', 294623.00, '万元');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 3, '开工项目', 2562.00, '个');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 4, '开工比例', 98.25, '%');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 5, '逾期办件', 14325.00, '个');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 6, '逾期比例', 10.58, '%');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 7, '平均审批用时', 2048.00, '分钟');
INSERT INTO `t_ywym_ywtg_hbs_gcsp_zb` VALUES (NULL, NULL, NULL, 8, '跟踪回访数量', 10480.00, '个');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_ggzwfwzxbjqk_lb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_ggzwfwzxbjqk_lb`;
CREATE TABLE `t_ywym_ywtg_hbs_ggzwfwzxbjqk_lb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `zwfwzxmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '政务服务中心名称',
  `zbjl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总办件量',
  `zbjrs` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '总办件人数',
  `ycblcgl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '一次办理成功率',
  `myl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '满意率',
  `cps` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '差评数',
  `cpblsx` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '差评办理事项',
  `aqzgl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '按期整改率'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_各个政务服务中心办件情况_列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_ggzwfwzxbjqk_lb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_ggzwfwzxbjqk_lb` VALUES (NULL, NULL, NULL, 1, '浑南区政务服务中心', '803', '569', '93.5', '95.63', '33', '1事项2事项3事项4事项5事项', '98.6');
INSERT INTO `t_ywym_ywtg_hbs_ggzwfwzxbjqk_lb` VALUES (NULL, NULL, NULL, 2, '沈河区政务服务中心', '458', '456', '75.6', '84.2', '45', '1事项2事项3事项4事项5事项', '85.6');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_hqbm_bjcqqk_lb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb`;
CREATE TABLE `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `qh` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '切换',
  `sjdw` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '市级单位',
  `cqbjl` decimal(10, 2) NULL DEFAULT NULL COMMENT '超期办件率',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_惠企便民_办件超期情况_列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_hqbm_bjcqqk_lb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 1, '个人办事', 'XX市级单位', 78.45, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 2, '个人办事', 'XXX市级单位', 68.56, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 3, '个人办事', 'XXXXX市级单位', 65.26, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 4, '个人办事', 'XXXXX市级单位', 63.15, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 5, '个人办事', 'XXXXXX市级单位', 62.11, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 1, '法人办事', 'XX市级单位', 78.45, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 2, '法人办事', 'XXX市级单位', 68.56, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 3, '法人办事', 'XXXXX市级单位', 65.26, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 4, '法人办事', 'XXXXX市级单位', 63.15, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjcqqk_lb` VALUES (NULL, NULL, NULL, 5, '法人办事', 'XXXXXX市级单位', 62.11, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_hqbm_bjspqk_zzt
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt`;
CREATE TABLE `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `qh` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '切换',
  `pjcnys` decimal(10, 2) NULL DEFAULT NULL COMMENT '平均承诺用时',
  `pjspys` decimal(10, 2) NULL DEFAULT NULL COMMENT '平均审批用时',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_惠企便民_办件审批情况_柱状图' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_hqbm_bjspqk_zzt
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 1, '个人办事', 6.00, 8.90, '1月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 2, '个人办事', 6.00, 5.60, '2月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 3, '个人办事', 6.00, 7.50, '3月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 4, '个人办事', 6.00, 2.60, '4月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 5, '个人办事', 6.00, 3.60, '5月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 6, '个人办事', 6.00, 5.80, '6月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 1, '法人办事', 6.00, 4.90, '1月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 2, '法人办事', 6.00, 5.60, '2月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 3, '法人办事', 6.00, 6.90, '3月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 4, '法人办事', 6.00, 7.80, '4月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 5, '法人办事', 6.00, 5.80, '5月');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_bjspqk_zzt` VALUES (NULL, NULL, NULL, 6, '法人办事', 6.00, 6.90, '6月');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_hqbm_cpjj_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_hqbm_cpjj_zb`;
CREATE TABLE `t_ywym_ywtg_hbs_hqbm_cpjj_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `qh` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '切换',
  `zbx` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '指标项'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_差评聚焦_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_hqbm_cpjj_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 1, '个人办事', '对待客户服务态度差');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 2, '个人办事', '办事响应不及时');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 3, '个人办事', '推销其他业务');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 4, '个人办事', '没有后续跟进');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 5, '个人办事', '未限期办理');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 6, '个人办事', '没有引导办理');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 1, '法人办事', '对待客户服务态度差');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 2, '法人办事', '办事响应不及时');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 3, '法人办事', '推销其他业务');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 4, '法人办事', '没有后续跟进');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 5, '法人办事', '未限期办理');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_cpjj_zb` VALUES (NULL, NULL, NULL, 6, '法人办事', '没有引导办理');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_hqbm_ycblcgl_qs
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs`;
CREATE TABLE `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `qh` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '切换',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `ycblcgl` decimal(10, 2) NULL DEFAULT NULL COMMENT '一次办理成功率'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_惠企便民_一次办理成功率_趋势' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_hqbm_ycblcgl_qs
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 1, '个人办事', '1月', 25.30);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 2, '个人办事', '2月', 25.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 3, '个人办事', '3月', 24.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 4, '个人办事', '4月', 45.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 5, '个人办事', '5月', 56.80);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 6, '个人办事', '6月', 45.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 1, '法人办事', '1月', 25.30);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 2, '法人办事', '2月', 25.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 3, '法人办事', '3月', 24.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 4, '法人办事', '4月', 45.60);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 5, '法人办事', '5月', 56.80);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_ycblcgl_qs` VALUES (NULL, NULL, NULL, 6, '法人办事', '6月', 45.60);

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_hqbm_yjsycb_qs
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_hqbm_yjsycb_qs`;
CREATE TABLE `t_ywym_ywtg_hbs_hqbm_yjsycb_qs`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `qh` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '切换',
  `sj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `bjsl` decimal(20, 0) NULL DEFAULT NULL COMMENT '办件数量'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_惠企便民_一件事一次办_趋势' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_hqbm_yjsycb_qs
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 1, '个人办事', '1月', 253);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 2, '个人办事', '2月', 256);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 3, '个人办事', '3月', 246);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 4, '个人办事', '4月', 456);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 5, '个人办事', '5月', 568);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 6, '个人办事', '6月', 456);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 1, '法人办事', '1月', 253);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 2, '法人办事', '2月', 256);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 3, '法人办事', '3月', 246);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 4, '法人办事', '4月', 456);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 5, '法人办事', '5月', 568);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_yjsycb_qs` VALUES (NULL, NULL, NULL, 6, '法人办事', '6月', 456);

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_hqbm_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_hqbm_zb`;
CREATE TABLE `t_ywym_ywtg_hbs_hqbm_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(20, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_惠企便民_指标(左侧全部)' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_hqbm_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 1, '个人办事', '总办件量', 1562.00, '万件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 2, '个人办事', '总办件人数', 480.26, '万人');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 3, '个人办事', '事项数量', 1562.00, '件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 4, '个人办事', '超期在办数', 245.00, '件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 5, '个人办事', '超期办件数', 452.00, '件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 6, '个人办事', '综合满意率', 85.26, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 7, '个人办事', '评价量', 2456.00, NULL);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 8, '个人办事', '按期整改率', 78.26, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 9, '个人办事', '差评量', 886.00, NULL);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 1, '法人办事', '总办件量', 1562.00, '万件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 2, '法人办事', '总办件人数', 480.26, '万人');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 3, '法人办事', '事项数量', 1562.00, '件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 4, '法人办事', '超期在办数', 245.00, '件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 5, '法人办事', '超期办件数', 452.00, '件');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 6, '法人办事', '综合满意率', 85.26, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 7, '法人办事', '评价量', 2456.00, NULL);
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 8, '法人办事', '按期整改率', 78.26, '%');
INSERT INTO `t_ywym_ywtg_hbs_hqbm_zb` VALUES (NULL, NULL, NULL, 9, '法人办事', '差评量', 886.00, NULL);
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_ym_zb` VALUES (NULL, NULL, NULL, 1, '总量', '总办件量', 1256, '万件');
INSERT INTO `t_ywym_ywtg_hbs_ym_zb` VALUES (NULL, NULL, NULL, 2, '总量', '一次办理成功率', 97, '%');
INSERT INTO `t_ywym_ywtg_hbs_ym_zb` VALUES (NULL, NULL, NULL, 3, '总量', '满意率', 91, '%');
INSERT INTO `t_ywym_ywtg_hbs_ym_zb` VALUES (NULL, NULL, NULL, 1, '今日', '总办件量', 1256, '万件');
INSERT INTO `t_ywym_ywtg_hbs_ym_zb` VALUES (NULL, NULL, NULL, 2, '今日', '一次办理成功率', 97, '%');
INSERT INTO `t_ywym_ywtg_hbs_ym_zb` VALUES (NULL, NULL, NULL, 3, '今日', '满意率', 91, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_hbs_zwfwzx_tips
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_hbs_zwfwzx_tips`;
CREATE TABLE `t_ywym_ywtg_hbs_zwfwzx_tips`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `mc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名称',
  `sjtjrq` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '数据统计日期',
  `bjl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '办件量',
  `bjrs` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '办件人数',
  `bjcks` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '办件窗口数',
  `ycblcgl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '一次办理成功率',
  `myl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '满意率',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '好办事_政务服务中心_TIPS' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_hbs_zwfwzx_tips
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hbs_zwfwzx_tips` VALUES (NULL, NULL, NULL, 1, '沈河区政务服务中心', '2022-06-09', '197', '224', '16', '90.6', '82.62', NULL, NULL);
...
CREATE TABLE `t_ywym_ywtg_hjy_scgqfx_zb`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `zbx` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '指标项',
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hjyi_mzgh_yyghrctop5_zb` VALUES (NULL, NULL, NULL, 1, '沈阳医学院附属医院', 4512.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_mzgh_yyghrctop5_zb` VALUES (NULL, NULL, NULL, 2, '皇姑区中心医院', 3254.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_mzgh_yyghrctop5_zb` VALUES (NULL, NULL, NULL, 3, '盛京医院', 2354.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_mzgh_yyghrctop5_zb` VALUES (NULL, NULL, NULL, 4, '沈阳市股骨科医院', 1523.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_mzgh_yyghrctop5_zb` VALUES (NULL, NULL, NULL, 5, '沈阳中医药大学附属医院', 1111.00, '万人次');
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hjyi_zjjfqk_yyzjrctop5_zb` VALUES (NULL, NULL, NULL, 1, '和康医院', 4512.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_zjjfqk_yyzjrctop5_zb` VALUES (NULL, NULL, NULL, 2, '北部医院', 3254.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_zjjfqk_yyzjrctop5_zb` VALUES (NULL, NULL, NULL, 3, '一五八医院', 2354.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_zjjfqk_yyzjrctop5_zb` VALUES (NULL, NULL, NULL, 4, '沈阳市第一人民医院', 1523.00, '万人次');
INSERT INTO `t_ywym_ywtg_hjyi_zjjfqk_yyzjrctop5_zb` VALUES (NULL, NULL, NULL, 5, '辽宁省儿童医院', 1111.00, '万人次');
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 1, '发放金额', '电子优惠券发放金额', 1456253.00, '元');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 2, '发放金额', '2元', 253.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 3, '发放金额', '5元', 3652.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 4, '发放金额', '10元', 2543.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 5, '发放金额', '20元', 2523.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 1, '使用金额', '电子优惠券使用金额', 142535.00, '元');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 2, '使用金额', '2元', 253.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 3, '使用金额', '5元', 3652.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 4, '使用金额', '10元', 2543.00, '张');
INSERT INTO `t_ywym_ywtg_htc_yhqqk_zb` VALUES (NULL, NULL, NULL, 5, '使用金额', '20元', 2523.00, '张');
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 1, '区域性居家养老服务中心A', '南街12号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 2, '区域性居家养老服务中心B', '北街14号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 3, '区域性居家养老服务中心C', '于洪街道', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 4, '区域性居家养老服务中心D', '南街12号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 5, '区域性居家养老服务中心E', '北街14号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 6, '区域性居家养老服务中心F', '于洪街道', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 7, '区域性居家养老服务中心G', '南街12号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 8, '区域性居家养老服务中心H', '北街14号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 9, '区域性居家养老服务中心I', '于洪街道', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 10, '区域性居家养老服务中心J', '南街12号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 11, '区域性居家养老服务中心K', '北街14号', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 12, '区域性居家养老服务中心L', '于洪街道', '某某类别', '三星级');
INSERT INTO `t_ywym_ywtg_hyl_sssj_gbmbjg_lb` VALUES (NULL, NULL, NULL, 13, '区域性居家养老服务中心M', '南街12号', '某某类别', '三星级');
...
-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_bmlb_lb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_bmlb_lb`;
CREATE TABLE `t_ywym_ywtg_yw_bmlb_lb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `dwmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位名称',
  `ywxt` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '业务系统',
  `fwq` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '服务器',
  `clq` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '处理器',
  `nc` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '内存',
  `cc` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '储存'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_部门列表_列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_bmlb_lb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_bmlb_lb` VALUES (NULL, NULL, NULL, 1, '信访局', '1', '2', '3', '45', '400');
INSERT INTO `t_ywym_ywtg_yw_bmlb_lb` VALUES (NULL, NULL, NULL, 2, '民政局', '1', '2', '3', '45', '400');
INSERT INTO `t_ywym_ywtg_yw_bmlb_lb` VALUES (NULL, NULL, NULL, 3, '林业局', '1', '2', '3', '45', '400');
INSERT INTO `t_ywym_ywtg_yw_bmlb_lb` VALUES (NULL, NULL, NULL, 4, '省委', '1', '2', '3', '45', '400');
INSERT INTO `t_ywym_ywtg_yw_bmlb_lb` VALUES (NULL, NULL, NULL, 5, '省政府', '1', '2', '3', '45', '400');
INSERT INTO `t_ywym_ywtg_yw_bmlb_lb` VALUES (NULL, NULL, NULL, 6, '考试院', '1', '2', '3', '45', '400');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb`;
CREATE TABLE `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `xtmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '系统名称',
  `fwsl` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问数量'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络服务_业务系统本月访问数量_列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb` VALUES (NULL, NULL, NULL, 1, '信访信息系统', '586');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb` VALUES (NULL, NULL, NULL, 2, '民政信息系统', '564');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb` VALUES (NULL, NULL, NULL, 3, '门户网站系统', '125');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb` VALUES (NULL, NULL, NULL, 4, '信息中心', '142');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwsl_lb` VALUES (NULL, NULL, NULL, 5, '公安局信息系统', '563');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb`;
CREATE TABLE `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络服务_业务系统本月服务质量_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb` VALUES (NULL, NULL, NULL, 1, '最好TOP3', '门户网站系统', 98.00, '%');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb` VALUES (NULL, NULL, NULL, 2, '最好TOP3', '信访业务系统', 85.60, '%');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb` VALUES (NULL, NULL, NULL, 3, '最好TOP3', '信息中心', 75.65, '%');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb` VALUES (NULL, NULL, NULL, 1, '最差TOP3', '门户网站系统B', 98.00, '%');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb` VALUES (NULL, NULL, NULL, 2, '最差TOP3', '信访业务系统B', 85.60, '%');
INSERT INTO `t_ywym_ywtg_yw_wlfw_ywxtbyfwzl_zb` VALUES (NULL, NULL, NULL, 3, '最差TOP3', '信息中心B', 75.65, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlfw_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlfw_zb`;
CREATE TABLE `t_ywym_ywtg_yw_wlfw_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络服务_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlfw_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlfw_zb` VALUES (NULL, NULL, NULL, 1, '总量', 5469.00, NULL);
INSERT INTO `t_ywym_ywtg_yw_wlfw_zb` VALUES (NULL, NULL, NULL, 2, '业务系统总平均质量', 89.26, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb`;
CREATE TABLE `t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `zbx` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '指标项',
  `value` decimal(15, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络状态_业务系统今日流量情况_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb` VALUES (NULL, NULL, NULL, 1, '总量', 1457.26, 'GB');
INSERT INTO `t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb` VALUES (NULL, NULL, NULL, 2, '网站群管理平台', 488.72, 'GB');
INSERT INTO `t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb` VALUES (NULL, NULL, NULL, 3, '智慧政务协同办公平台', 134.98, 'GB');
INSERT INTO `t_ywym_ywtg_yw_wlzt_ywxtjrllqk_zb` VALUES (NULL, NULL, NULL, 4, '沈阳政务服务网', 112.36, 'GB');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlzt_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlzt_zb`;
CREATE TABLE `t_ywym_ywtg_yw_wlzt_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `zb` decimal(10, 2) NULL DEFAULT NULL COMMENT '占比',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络状态_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlzt_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlzt_zb` VALUES (NULL, NULL, NULL, 1, '正常', 1456, 63.00, '%');
INSERT INTO `t_ywym_ywtg_yw_wlzt_zb` VALUES (NULL, NULL, NULL, 2, '异常', 469, 37.00, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlzy_wstj_zzt
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlzy_wstj_zzt`;
CREATE TABLE `t_ywym_ywtg_yw_wlzy_wstj_zzt`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `dwmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位名称',
  `ws` decimal(10, 2) NULL DEFAULT NULL COMMENT '网速'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络资源_网速统计_柱状图' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlzy_wstj_zzt
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 1, '信访局', 456.00);
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 2, '民政局', 235.00);
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 3, '农业局', 456.00);
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 4, '农机局', 123.00);
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 5, '林业局', 256.30);
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 6, '公安局', 336.20);
INSERT INTO `t_ywym_ywtg_yw_wlzy_wstj_zzt` VALUES (NULL, NULL, NULL, 7, '城市建设局', 452.00);

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_wlzy_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_wlzy_zb`;
CREATE TABLE `t_ywym_ywtg_yw_wlzy_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_网络资源_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_wlzy_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_wlzy_zb` VALUES (NULL, NULL, NULL, 1, '政务外网', 81.00, '个');
INSERT INTO `t_ywym_ywtg_yw_wlzy_zb` VALUES (NULL, NULL, NULL, 2, '政务专网', 3.00, '个');
INSERT INTO `t_ywym_ywtg_yw_wlzy_zb` VALUES (NULL, NULL, NULL, 3, '政务外网互联网出口', 27.00, 'G');
INSERT INTO `t_ywym_ywtg_yw_wlzy_zb` VALUES (NULL, NULL, NULL, 4, '网络平均速率', 587.00, 'Mbps');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb`;
CREATE TABLE `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_虚拟机资源_虚拟机内存利用率_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb` VALUES (NULL, NULL, NULL, 1, '系统名称1', 95.20, '%');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb` VALUES (NULL, NULL, NULL, 2, '系统名称2', 45.60, '%');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb` VALUES (NULL, NULL, NULL, 3, '系统名称3', 85.46, '%');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb` VALUES (NULL, NULL, NULL, 4, '系统名称4', 78.39, '%');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_xnjnclyl_zb` VALUES (NULL, NULL, NULL, 5, '系统名称5', 88.56, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_xnjzy_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_xnjzy_zb`;
CREATE TABLE `t_ywym_ywtg_yw_xnjzy_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(15, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_虚拟机资源_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_xnjzy_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_xnjzy_zb` VALUES (NULL, NULL, NULL, 1, '健康度', 96.20, '%');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_zb` VALUES (NULL, NULL, NULL, 2, '内存总量', 2456.00, 'TB');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_zb` VALUES (NULL, NULL, NULL, 3, '储存总量', 62.50, 'TB');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_zb` VALUES (NULL, NULL, NULL, 4, '服务器总量', 108.00, '台');
INSERT INTO `t_ywym_ywtg_yw_xnjzy_zb` VALUES (NULL, NULL, NULL, 5, '处理器总量', 4586.00, '核');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_ywgl_tx
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_ywgl_tx`;
CREATE TABLE `t_ywym_ywtg_yw_ywgl_tx`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(15, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_云网概览_特效' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_ywgl_tx
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 1, '联通云', 92.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 2, '阿里云', 142.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 3, '移动云', 183.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 4, '互联网区', 46.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 5, '华为云', 123.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 6, '灾备区', 175.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 7, '系统上云率', 76.00, '%');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 8, '系统上云', 243.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 9, '信创云', 87.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 10, '部门上云', 123.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 11, '自有云', 175.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 12, '政务外网', 81.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 13, '政务专网', 3.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywgl_tx` VALUES (NULL, NULL, NULL, 14, '警告数', 18.00, '个');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_ywxtjg_lb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_ywxtjg_lb`;
CREATE TABLE `t_ywym_ywtg_yw_ywxtjg_lb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `dwmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位名称',
  `xtmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '系统名称',
  `sjmx` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '事件明细',
  `dj` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '等级'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_业务系统警告_列表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_ywxtjg_lb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_lb` VALUES (NULL, NULL, NULL, 1, '民政局', '门户网站', '误操作', '绿');
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_lb` VALUES (NULL, NULL, NULL, 2, '信访局', '信访信息系统', '误操作', '黄');
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_lb` VALUES (NULL, NULL, NULL, 3, '省委', '省委门户', '误操作', '红');
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_lb` VALUES (NULL, NULL, NULL, 4, '省政府', '省政府门户', '误操作', '绿');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_ywxtjg_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_ywxtjg_zb`;
CREATE TABLE `t_ywym_ywtg_yw_ywxtjg_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_业务系统警告_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_ywxtjg_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_zb` VALUES (NULL, NULL, NULL, 1, '绿色', 53.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_zb` VALUES (NULL, NULL, NULL, 2, '黄色', 53.00, '个');
INSERT INTO `t_ywym_ywtg_yw_ywxtjg_zb` VALUES (NULL, NULL, NULL, 3, '红色', 53.00, '个');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_zjzy_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_zjzy_zb`;
CREATE TABLE `t_ywym_ywtg_yw_zjzy_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(15, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_主机资源_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_zjzy_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_zjzy_zb` VALUES (NULL, NULL, NULL, 1, '健康度', 96.20, '%');
INSERT INTO `t_ywym_ywtg_yw_zjzy_zb` VALUES (NULL, NULL, NULL, 2, '内存总量', 2456.00, 'TB');
INSERT INTO `t_ywym_ywtg_yw_zjzy_zb` VALUES (NULL, NULL, NULL, 3, '储存总量', 62.50, 'TB');
INSERT INTO `t_ywym_ywtg_yw_zjzy_zb` VALUES (NULL, NULL, NULL, 4, '服务器总量', 108.00, '台');
INSERT INTO `t_ywym_ywtg_yw_zjzy_zb` VALUES (NULL, NULL, NULL, 5, '处理器总量', 4586.00, '核');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_zjzy_zjlyl_qs
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_zjzy_zjlyl_qs`;
CREATE TABLE `t_ywym_ywtg_yw_zjzy_zjlyl_qs`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `sj` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '时间',
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_主机资源_主机利用率_趋势' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_zjzy_zjlyl_qs
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 1, '存储', '1月', 52.30);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 2, '存储', '2月', 53.60);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 3, '存储', '3月', 56.40);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 4, '存储', '4月', 48.62);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 5, '存储', '5月', 45.89);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 6, '存储', '6月', 55.60);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 1, 'CPU', '1月', 52.30);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 2, 'CPU', '2月', 53.60);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 3, 'CPU', '3月', 56.40);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 4, 'CPU', '4月', 48.62);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 5, 'CPU', '5月', 45.89);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 6, 'CPU', '6月', 55.60);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 1, '内存', '1月', 52.30);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 2, '内存', '2月', 53.60);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 3, '内存', '3月', 56.40);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 4, '内存', '4月', 48.62);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 5, '内存', '5月', 45.89);
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_qs` VALUES (NULL, NULL, NULL, 6, '内存', '6月', 55.60);

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_zjzy_zjlyl_zb
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_zjzy_zjlyl_zb`;
CREATE TABLE `t_ywym_ywtg_yw_zjzy_zjlyl_zb`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `value` decimal(10, 2) NULL DEFAULT NULL COMMENT '值',
  `unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_主机资源_主机利用率_指标' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_zjzy_zjlyl_zb
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_zb` VALUES (NULL, NULL, NULL, 1, '内存', '内存利用率', 92.50, '%');
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_zb` VALUES (NULL, NULL, NULL, 2, '存储', '存储利用率', 93.20, '%');
INSERT INTO `t_ywym_ywtg_yw_zjzy_zjlyl_zb` VALUES (NULL, NULL, NULL, 3, 'CPU', 'CPU利用率', 56.40, '%');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_zyfx_tips
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_zyfx_tips`;
CREATE TABLE `t_ywym_ywtg_yw_zyfx_tips`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  ...
  `lon` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '经度',
  `lat` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '纬度',
  `ywxtsl` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '业务系统数量',
  `fwqts` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '服务器台数',
  `cpuhs` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'CPU核数',
  `ccdx` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '存储大小',
  `ncdx` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '内存大小'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_资源分析_TIPS' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_zyfx_tips
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_zyfx_tips` VALUES (NULL, NULL, NULL, 1, '沈阳市沈河区委办局', NULL, NULL, '547', '1585', '98', '3145', '68');

-- ----------------------------
-- Table structure for t_ywym_ywtg_yw_zyfx_tips_xt
-- ----------------------------
DROP TABLE IF EXISTS `t_ywym_ywtg_yw_zyfx_tips_xt`;
CREATE TABLE `t_ywym_ywtg_yw_zyfx_tips_xt`  (
  `id` bigint(20) NULL DEFAULT NULL COMMENT '主键',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `px` int(11) NULL DEFAULT NULL COMMENT '排序',
  `dwmc` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '单位名称',
  `xtmc` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '系统名称'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '云网_资源分析_TIPS_系统' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_ywym_ywtg_yw_zyfx_tips_xt
-- ----------------------------
INSERT INTO `t_ywym_ywtg_yw_zyfx_tips_xt` VALUES (NULL, NULL, NULL, 1, '沈阳市沈河区委办局', '业务系统1');
INSERT INTO `t_ywym_ywtg_yw_zyfx_tips_xt` VALUES (NULL, NULL, NULL, 2, '沈阳市沈河区委办局', '业务系统2');
INSERT INTO `t_ywym_ywtg_yw_zyfx_tips_xt` VALUES (NULL, NULL, NULL, 3, '沈阳市沈河区委办局', '业务系统3');
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_zs_zsptgk_apidyqsfx_qs` VALUES (NULL, NULL, NULL, 1, 246356, '06-01');
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 1, '接入源系统统计', '沈阳市高新区某某局', 987456, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 2, '接入源系统统计', '沈阳市高新区某某局', 874561, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 3, '接入源系统统计', '沈阳市高新区某某局', 745612, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 4, '接入源系统统计', '沈阳市高新区某某局', 645612, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 5, '接入源系统统计', '沈阳市高新区某某局', 541365, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 6, '接入源系统统计', '沈阳市高新区某某局', 531456, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 7, '接入源系统统计', '沈阳市高新区某某局', 521345, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 8, '接入源系统统计', '沈阳市高新区某某局', 501235, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 9, '接入源系统统计', '沈阳市高新区某某局', 498546, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 10, '接入源系统统计', '沈阳市高新区某某局', 487625, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 11, '接入源系统统计', '沈阳市高新区某某局', 475612, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 12, '接入源系统统计', '沈阳市高新区某某局', 462356, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 13, '接入源系统统计', '沈阳市高新区某某局', 441256, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 1, '接入API统计', '沈阳市高新区某某局', 987456, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 2, '接入API统计', '沈阳市高新区某某局', 874561, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 3, '接入API统计', '沈阳市高新区某某局', 745612, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 4, '接入API统计', '沈阳市高新区某某局', 645612, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 5, '接入API统计', '沈阳市高新区某某局', 541365, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 6, '接入API统计', '沈阳市高新区某某局', 531456, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 1, '接入库表统计', '沈阳市高新区某某局', 521345, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 2, '接入库表统计', '沈阳市高新区某某局', 501235, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 3, '接入库表统计', '沈阳市高新区某某局', 498546, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 4, '接入库表统计', '沈阳市高新区某某局', 487625, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 5, '接入库表统计', '沈阳市高新区某某局', 475612, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 6, '接入库表统计', '沈阳市高新区某某局', 462356, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_jryxtpm_zb` VALUES (NULL, NULL, NULL, 7, '接入库表统计', '沈阳市高新区某某局', 441256, '个');
...
-- ----------------------------
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 1, '接入源系统统计', '接入源系统总数', 1235.0000, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 2, '接入API统计', '接入API接口总数', 24523.0000, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 3, '接入库表统计', '接入库表总数', 2356425.0000, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 4, NULL, '开放API接口总数', 253456.0000, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 5, NULL, '开放数据库表总数', 5465242.0000, '个');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 6, NULL, '累计数据消费次数', 14526.0000, '次');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 7, NULL, '累计API调用次数', 54356.0000, '次');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 8, NULL, '累计推送数据次数', 54568925.0000, '次');
INSERT INTO `t_ywym_ywtg_zs_zsptgk_zb` VALUES (NULL, NULL, NULL, 9, NULL, '累计推送数据条数', 4568.3564, '万条');
